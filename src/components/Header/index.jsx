...
export default function Header() {
  ...
  const [isBonsaiWorkflowMenuOpen, setIsBonsaiWorkflowMenuOpen] =
    useState(false);
          ...
          <ul className="list-links">
            <li className="menu-item">
              <div className="menu-title">
                <a href="#" target="_self" title="Access products">
                  Product
                </a>
              ...
              <ul
                className={
                  isProductMenuOpen ? "product-menu ativo" : "product-menu"
                }
              >
                <li>
                  <div className="menu-title">
                    <a href="#" target="_self" title="Access Bonsai">
                      Bonsai Workflow
                    </a>
                    ...
                    <img
                      ...
                      alt="toggle menu"
                      onClick={() =>
                        setIsBonsaiWorkflowMenuOpen(!isBonsaiWorkflowMenuOpen)
                      }
                    />
                  </div>
                  ...
                  >
                    <li>
                      <a href="#" target="_self" title="Access invoices">
                        Invoices
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="#" target="_self" title="Access contracts">
                        Contracts
                      </a>
                    </li>
                    <li>
                      <a href="#" target="_self" title="Access client CRM">
                        Client CRM
                      </a>
                    </li>
                    <li>
                      <a
                        href="#"
                        target="_self"
                        title="Access forms & automations"
                      >
                        Forms & Automations
                      </a>
                    </li>
                ...
                <li>
                  <a
                    href="#"
                    target="_self"
                    title="Access Bonsai Time Tracking"
                  >
                    Bonsai Tax
                  </a>
                </li>
            ...
            <li className="menu-item">
              <div className="menu-title">
                <a href="#" target="_self" title="Access templates">
                  Templates
                </a>
              ...
              <ul
                className={
                  isTemplatesMenuOpen ? "product-menu ativo" : "product-menu"
                }
              >
                <li>
            ...
            <li className="menu-item">
              <a href="#" target="_self" title="Access pricing">
                Pricing
              </a>
            </li>
            <li className="menu-item">
